...
bbox_coords <- c(xmin = -66, xmax = -50, ymin = 39, ymax = 48)
...
```{r, fig.align="center", echo = FALSE, fig.pos='H',fig.cap="Stratification and salinity (ppt) for the ESS from 1970-2018. Dashed lines denote the long-term mean, solid lines denote ."}
dat.dir<-here::here("data")
...
- Salinity and stratification in the Eastern Scotian Shelf (NAFO 4Vn, 4Vs, 4W) have been generally higher, with more years above the long-term mean in the ESS since the early 1990s. In later years (2018), both were slightly below the long-term mean, but within a normal range. These trends are consistent with SST trends for the ESS.
...
```{r ,fig.align="center", echo = FALSE,fig.pos='H', fig.pos='H',fig.width=11.7, fig.height=8.3, fig.cap="Main fisheries in NAFO 4VS by landings from all countries from 1960-2023. Data is from the NAFO STATLAN21A database."}
...
```{r, fig.align="center", echo = FALSE, fig.pos='H',fig.height=8, fig.width=10, fig.cap ="Commercial landings (kg) collected from NAFO, ZIF and MARFIS databases for species categories. Dashed lines represent the mean, solid green lines denote ± standard deviation (SD). Purple, shaded areas are the latest 5 years of available data."}
...
```
- In the ESS bloom statistics are within the long-term mean range for the latest year (2020), and show no long-term or short term (5 year) trend over time. 

### *Calanus finmarchicus*, Zooplankton Biomass
```{r fig.align="center", echo = FALSE,fig.pos='H', fig.cap="Zooplankton biomass (dry weight), from NAFO 4V. Dashed lines represent the mean, solid green lines denote ± standard deviation (SD). Purple, shaded areas are the latest 5 years of available data. "}
